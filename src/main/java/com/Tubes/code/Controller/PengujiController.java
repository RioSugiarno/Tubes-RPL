...
public class PengujiController {
    ...
    // Informasi Sidang Default /w NID
    ...
    //     }
    //     System.out.println("NID Penguji: " + nidPenguji);
    
    //     // Ambil data sidang berdasarkan NID penguji
    //     List<InfoTugasAkhir> informasiSidang = infoTugasAkhirService.getSidangByPenguji(nidPenguji);

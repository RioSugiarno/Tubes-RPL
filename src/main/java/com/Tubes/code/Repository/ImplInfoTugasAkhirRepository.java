...
public class ImplInfoTugasAkhirRepository implements InfoTugasAkhirRepository{
    ...
    @Override
    public boolean insertBap(int idTa, String nidPenguji1, String nidPenguji2, String nidPembimbing1, String nidPembimbing2, String nidMahasiswa, String nidKoordinator) {
        try {
            ...
            jdbcTemplate.update(query, idTa, nidPenguji1, nidPenguji2, nidPembimbing1, nidPembimbing2, nidMahasiswa, nidKoordinator);
            return true;
        } catch (DataAccessException e) {
